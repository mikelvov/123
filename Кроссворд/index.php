...
header('Content-type: text/html; charset=ut8-8');
...
<script type="text/javascript"><!--
	...
	Word = new Array("ПЛОВЕЦ", "НАУШНИКИ", "КНИГА", "МОТОЦИКЛ", "НОУТБУК", "ЧАЙНИК", "ЯНДЕКС");
	Clue = new Array("человек в воде", 
"устройство для прослушивания музыки", 
"Это можно читать", 
"двухколесное средство передвижения", 
"портативный компьютер", 
"устройство для подогревания воды", 
"Найдется все");
...
function CheckClick()
{
	...
	if (ErrorsFound > 0 && EmptyFound > 0)
		...
		document.getElementById("welcomemessage").innerHTML = "Ошибок не найдено, но найдено " + EmptyFound + (EmptyFound > 1 ? " незаполненных слов" : " incomplete word was") + " .";
...
<h3>Привет!</h3>
<p>Нажмите на любое слово, чтобы начать.</p>
</div>
...
<h3>Поздравляем!</h3>
<p>Вы выполнили кроссворд <a href="http://www.eclipsecrossword.com" style="color: black; text-decoration:none;">crossword puzzle</a>.
</p>
...
<div style="margin-top: 1em;">
	<button id="checkbutton" type="button" onclick="CheckClick();" style="display: none;">Проверить</button>
</div>
